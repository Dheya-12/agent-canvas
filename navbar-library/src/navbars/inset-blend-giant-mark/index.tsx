...
/**
 * Inset blend rail with an oversized wordmark.
 *
 * The rail floats 0.7vw inside the viewport rather than sitting flush, and
 * the wordmark fills its full height, so the mark — not the links — carries
 * the composition. Like the reference it inverts against the page with
 * mix-blend-mode: difference and scales every dimension with viewport width.
 */
export default function InsetBlendGiantMark({ content, className, style, onNavigate }: NavbarProps) {
